...
int AdivinaNumero::getNumeroJugador(int jugador) const {
        ...
        return -1; // Valor por defecto si el jugador no es válido
    }

    // Método para establecer el número secreto de un jugador
    void AdivinaNumero::setNumeroJugador(int jugador, int numero) {
        if (jugador == 1) {
            numeroJugador1 = numero;
            numeroJ1Elegido = true;
        } else if (jugador == 2) {
